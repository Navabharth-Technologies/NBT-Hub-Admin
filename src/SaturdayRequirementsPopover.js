...
const SaturdayRequirementsPopover = () => {
    ...
    const userData = JSON.parse(localStorage.getItem('navAuthUser') || localStorage.getItem('user') || '{}');
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                            ...
                                            <textarea
                                                ...
                                                style={{ width: '100%', height: '100px', padding: '15px', borderRadius: '16px', border: '1.5px solid #e2e8f0', fontSize: '14px', fontFamily: 'inherit', resize: 'none', transition: 'border-color 0.2s', boxSizing: 'border-box' }}
                                            />
                                        </div>
            ...
            <AnimatePresence>
                {isMinimized && !show && (
                    <motion.div
                        ...
                        onDragStart={() => { window.isDraggingIcon = true; }}
                        onDragEnd={() => { setTimeout(() => { window.isDraggingIcon = false; }, 150); }}
                        onClick={(e) => {
                            if (window.isDraggingIcon) { e.stopPropagation(); return; }
                            handleRestore();
                        }}
                        drag
                        dragMomentum={false}
